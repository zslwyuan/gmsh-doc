...
class GFace : public GEntity
{
  ...
  public:
    ...
    void XYZtoUV(double X, double Y, double Z, double &U, double &V, double relax, bool onSurface = true,
    ...
    virtual double curvatures(const SPoint2 &param, SVector3 &dirMax, SVector3 &dirMin, double &curvMax,
    ...
    bool fillPointCloud(double maxDist, std::vector<SPoint3> *points, std::vector<SPoint2> *uvpoints = nullptr,
